...
- Gera uma copia editada do `.bin` gravando equipe, abreviacao, estadio, tecnico, paises, nome, nome na camisa, posicao, pe forte, idade, altura e numero da camisa dos jogadores.
